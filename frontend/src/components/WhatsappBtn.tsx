...
const WhatsAppButton = ({ onClick, isOpen }: WhatsAppButtonProps) => {
  return (
    <button
      onClick={onClick}
      // Conditionally apply the 'animate-float' class
      className={`fixed bottom-8 right-8 bg-green-500 text-white p-5 rounded-full z-50 flex items-center justify-center transition-transform duration-300 ${
  ...
  <path d="M6 6 L18 18 M6 18 L18 6" stroke="white" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
</svg>
